...
class SwaggerCodeGenerator {
    ...
    String generateIndexes(List<String> fileNames, GeneratorOptions options) => _getSwaggerAdditionsGenerator(options).generateIndexes(fileNames);

    String generateConverterMappings(bool hasModels, GeneratorOptions options) => _getSwaggerAdditionsGenerator(options).generateConverterMappings(hasModels);
    ...
    String generateImportsContent(
        ...
        _getSwaggerAdditionsGenerator(options).generateImportsContent(swaggerFileName, hasModels, buildOnlyModels, hasEnums, separateModels);
    ...
    String generateCustomJsonConverter(String fileName, GeneratorOptions options) => _getSwaggerAdditionsGenerator(options).generateCustomJsonConverter(fileName);

    String generateDateToJson(GeneratorOptions options) => _getSwaggerAdditionsGenerator(options).generateDateToJson();

    SwaggerAdditionsGenerator _getSwaggerAdditionsGenerator(GeneratorOptions options) => SwaggerAdditionsGenerator(options);
