...
SwaggerSchema _$SwaggerSchemaFromJson(Map<String, dynamic> json) => SwaggerSchema(
        ...
        oneOf: (json['oneOf'] as List<dynamic>?)?.map((e) => SwaggerSchema.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
        anyOf: (json['anyOf'] as List<dynamic>?)?.map((e) => SwaggerSchema.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
        allOf: (json['allOf'] as List<dynamic>?)?.map((e) => SwaggerSchema.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
        ...
        hasAdditionalProperties: json['additionalProperties'] == null ? false : _additionalsFromJson(json['additionalProperties']),
