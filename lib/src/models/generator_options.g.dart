...
GeneratorOptions _$GeneratorOptionsFromJson(Map json) => GeneratorOptions(
        ...
        classesWithNullabeLists: (json['classes_with_nullabe_lists'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
        buildOnlyModels: json['build_only_models'] as bool? ?? false,
        defaultValuesMap: (json['default_values_map'] as List<dynamic>?)?.map((e) => DefaultValueMap.fromJson(Map<String, dynamic>.from(e as Map))).toList() ?? const <DefaultValueMap>[],
        defaultHeaderValuesMap: (json['default_header_values_map'] as List<dynamic>?)?.map((e) => DefaultHeaderValueMap.fromJson(Map<String, dynamic>.from(e as Map))).toList() ?? const <DefaultHeaderValueMap>[],
        responseOverrideValueMap: (json['response_override_value_map'] as List<dynamic>?)?.map((e) => ResponseOverrideValueMap.fromJson(Map<String, dynamic>.from(e as Map))).toList() ?? const <ResponseOverrideValueMap>[],
        ...
        inputUrls: (json['input_urls'] as List<dynamic>?)?.map((e) => InputUrl.fromJson(Map<String, dynamic>.from(e as Map))).toList() ?? const [],
        ...
        scalars: (json['scalars'] as Map?)?.map(
            ...
            const {},
        overridenModels: (json['overriden_models'] as List<dynamic>?)?.map((e) => OverridenModelsItem.fromJson(Map<String, dynamic>.from(e as Map))).toList() ?? const [],
