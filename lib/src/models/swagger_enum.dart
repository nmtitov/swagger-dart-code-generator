...
class SwaggerEnum {
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SwaggerEnum && runtimeType == other.runtimeType && name == other.name && isInteger == other.isInteger && DeepCollectionEquality().equals(defaultValue, other.defaultValue);
